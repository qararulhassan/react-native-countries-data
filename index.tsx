 ...
 * @param {?string} searchMessage Text to show user when no currency to show
 * @param {?string} lang Current selected lang by user
 * @param {?string} initialState Here you should define initial dial code
 * @param {?array} excludedCurrencies Array of currencies which should be excluded from picker
 * @param {Function} pickerButtonOnPress Function to receive selected currency
 * @param {Function} onBackdropPress Function to receive selected currency
 * @param {Function} onRequestClose Function to receive selected currency
 * @param {?Object} style Styles
 * @param {?React.ReactNode} itemTemplate Currency list template
 * @param rest
 */
